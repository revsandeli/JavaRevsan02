...
public class c3_nestedIfPractice {
    ...
    public static void main(String[] args) {
        ...
        //byte is not reasonable (beacuase weight can be more then 128 )
        //int (not usefull because it is whole number  weight can be decimal as well)
